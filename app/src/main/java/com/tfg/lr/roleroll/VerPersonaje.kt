...
class VerPersonaje : AppCompatActivity() {
    ...
    private lateinit var etxtRazaPj: EditText
    private lateinit var etxtClasePj: EditText
...
//    }
    ...
    private fun inicializarVariables() {
        ...
        etxtRazaPj = findViewById(R.id.etxtRazaPj)
        etxtClasePj = findViewById(R.id.etxtClasePj)
